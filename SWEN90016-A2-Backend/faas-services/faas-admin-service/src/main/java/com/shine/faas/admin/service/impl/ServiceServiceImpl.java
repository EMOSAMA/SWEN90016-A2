...
public class ServiceServiceImpl implements ServiceService {
    ...
    @Override
    public ReturnInfo queryAllService(DbContext context) throws Exception{
        List<Service> resultInfo =this.repositoryFactory.serviceRepository.queryAllService(context);
        return new ReturnInfo(resultInfo);
    }
}
