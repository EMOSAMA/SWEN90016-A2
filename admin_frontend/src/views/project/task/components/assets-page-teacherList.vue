<template>
  <div class="assets-page">
    ...
    <div class="operate-wrapper">
      <router-link :to="'/project/structure/class/'" class="link">
    ...
    <div class="operate-wrapper">
      ...
      <router-link :to="'/project/structure/allocateNewTeachers/' + $route.params.allocateUnitId " class="link">
        <el-button type="primary">添加新老师</el-button>
      </router-link>
    </div>
